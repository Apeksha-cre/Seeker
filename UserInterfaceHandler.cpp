...
{	
	...
	void UserInterface::launch() {
		...
		resume_handler.reviewResume(resume);*/					//RateResume - SSD 4
			...
			std::cout << "Enter your professionalSkills: \n";
			std::cin >> professionalSkills;
			std::cout << "Enter your interests: \n";
			std::cin >> interests;
			std::cout << "Enter your volunteerWork: \n";
			std::cin >> volunteerWork;
			std::cout << "Enter your education : \n";
			std::cin >> education;

			resume_handler.uploadResume(name, workExperience, professionalSkills, interests, volunteerWork, education);
			...
			std::cout << "Enter your creditCardNumber : \n";
			std::cin >> creditCardNumber;
			std::cout << "Enter your cardHolderName: \n";
			...
			resume_handler.paymentInfoSubmitted(creditCardNumber, cardHolderName, cvv, amount);
